...
class Pipe:
    ...
    def get_anthropic_models(self):
        return [
            ...
            # Claude 3.7 (2025) - Hybrid Reasoning Model
            {"id": "claude-3-7-sonnet-20250219", "name": "claude-3.7-sonnet"},
            {"id": "claude-3-7-sonnet-latest", "name": "claude-3.7-sonnet-latest"},
            # Claude 4 Family (2025)
            {"id": "claude-sonnet-4-20250514", "name": "claude-sonnet-4"},
            {"id": "claude-opus-4-1", "name": "claude-opus-4.1"},
            # Claude 4.5 Family (2025) - Latest
            {"id": "claude-sonnet-4-5-20250929", "name": "claude-sonnet-4.5"},
            {"id": "claude-sonnet-4-5-latest", "name": "claude-sonnet-4.5-latest"},
            {"id": "claude-haiku-4-5", "name": "claude-haiku-4.5"},
            {"id": "claude-haiku-4-5-latest", "name": "claude-haiku-4.5-latest"},
        ]
    ...
    def pipe(self, body: dict) -> Union[str, Generator, Iterator]:
        ...
        # Newer models (Claude 4.5+) don't allow both temperature and top_p
        # Only send temperature for these models
        is_newer_model = any(x in model_id for x in ["4-5", "4.5"])

        if is_newer_model:
            # Only use temperature for newer models
